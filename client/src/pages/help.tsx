    ...
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
      ...
      <div className="mx-auto w-full max-w-md md:max-w-lg lg:max-w-xl px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg">We're here to assist you with any questions or issues</p>
        </div>

        {/* Contact Information */}
        <div className="space-y-6">
          {/* Email Support */}
          <div className="bg-gray-50 dark:bg-gradient-to-r dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl p-6 border border-gray-200 dark:border-gray-600/30 hover:border-blue-500/50 transition-all duration-300">
          ...
          {/* Response Time */}
          <div className="bg-gray-50 dark:bg-gradient-to-r dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl p-6 border border-gray-200 dark:border-gray-600/30">
            <div className="flex items-start space-x-4">
          ...
          <div className="bg-gray-50 dark:bg-gradient-to-r dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl p-6 border border-gray-200 dark:border-gray-600/30">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-gray-900 dark:text-white font-medium mb-1">How do I reset my password?</h4>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Use the "Forgot Password" link on the login page or contact support.</p>
              </div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-medium mb-1">How do I verify my account?</h4>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Account verification is handled by administrators. Contact support if needed.</p>
              </div>
              <div>
                <h4 className="text-gray-900 dark:text-white font-medium mb-1">How do I report inappropriate content?</h4>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Use the three-dot menu on posts to report content or contact support directly.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center pt-6">
            ...
            <Button 
              onClick={handleEmailClick}
              variant="outline"
              className="border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-all duration-200"
            >
